...
--
- JupyterLab should open automatically in your browser if you are using Macbook
- You can access JupyterLab by entering the URL printed in the terminal after you run the jupyter lab command. It looks like the following: 
...
- Dictionary or hash – {‘key 1’: 6.9, ‘key2’: False} - group of key-value pairs
